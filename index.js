...
function lakukanLooping(arrPegawai) {
  ...
  */
  ...
  for (let index = 0; index < dataYangAkanDilooping.length; index++) {
    hasilLooping.push(`${arrayObjectPegawai[index].namaDepan} ${arrayObjectPegawai[index].namaBelakang}`)
  }
  // dataYangAkanDilooping.forEach((value) => {
  //   hasilLooping.push(`${value.namaDepan} ${value.namaBelakang}`);
  // })
